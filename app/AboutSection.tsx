      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-14 sm:mb-20">
          <div className="flex justify-center items-center gap-3 mb-4">
            <div className="w-8 h-px" style={{ background: "linear-gradient(90deg, transparent, #C49A4A)" }} />
            <span
            ...
            <div className="w-8 h-px" style={{ background: "linear-gradient(90deg, #C49A4A, transparent)" }} />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-start mb-14 sm:mb-20">
            ...
            >
              ...
              >
                <div
                  ...
                  style={{ background: "linear-gradient(135deg, #1E3A2A 0%, #2D4A3A 50%, #1A2E22 100%)" }}
                >
                  <div className="text-center p-6 sm:p-8 md:p-10">
                    <div
                      className="w-28 h-28 sm:w-36 sm:h-36 md:w-44 md:h-44 mx-auto mb-4 sm:mb-6 rounded-full flex items-center justify-center"
                      style={{
                        background: "var(--dark-forest)",
                        border: "3px solid var(--deep-forest)",
                      }}
                    >
                      <TreePine size={56} className="sm:w-16 sm:h-16 md:w-20 md:h-20" style={{ color: "#C49A4A" }} />
                    </div>
                    <p
                      className="font-display font-black text-sm sm:text-base md:text-xl tracking-wider"
                      style={{ color: "var(--parchment)" }}
                    >
                      GROWING STRONG
                    </p>
          ...
          <div className="space-y-5 sm:space-y-6">
            <div
              className="p-5 sm:p-6 md:p-8 relative"
              style={{
                background: "var(--pine)",
                border: "5px solid var(--deep-forest)",
                borderRadius: "16px",
            ...
            >
              <h3
                className="font-display text-2xl sm:text-3xl font-bold mb-4 tracking-tight"
                style={{ color: "var(--parchment)" }}
              >
                Growing Strong
              </h3>

              <p className="font-body leading-relaxed mb-4 text-sm sm:text-base" style={{ color: "var(--mist)" }}>
              ...
              <p className="font-body leading-relaxed text-sm sm:text-base" style={{ color: "var(--sage)" }}>
              ...
              <div className="mt-5 h-1.5 rounded-full"
                style={{ background: "linear-gradient(90deg, #C49A4A 0%, #D4A84B 50%, transparent 100%)" }}
              />
            </div>
